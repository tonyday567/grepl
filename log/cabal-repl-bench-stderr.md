src/Grepl.hs:11:1: warning: [GHC-66111] [-Wunused-imports]
...
src/Grepl.hs:12:1: warning: [GHC-66111] [-Wunused-imports]
   ...
   |
12 | import Control.Concurrent.Async (race, async)
   | ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

src/Grepl.hs:13:1: warning: [GHC-66111] [-Wunused-imports]
